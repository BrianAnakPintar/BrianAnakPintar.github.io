    ...
    <div className="homepage-div">
      <div className="homepage-container">
        ...
        <div className="homepage-text-part">
          ...
          >
            Hi<span className="blue">,</span> my name is Brian
            <span style={{ color: "#0087ca" }}>.</span>
          </motion.h1>
          <motion.p
          ...
          >
            I am an undergrad at{" "}
            <a href="https://www.cs.ubc.ca/" target="_blank">
              UBC
            </a>{" "}
            majoring in Honours Computer Science.
            <br />I usually don't update this site. But when I do, I yap about
